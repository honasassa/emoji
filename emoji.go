...
func main() {
    ...
    app := cli.NewApp()
    app.Name = "emoji"
    app.Usage = "emoji utility tool"
    app.Commands = []cli.Command {
    {
        Name:      "list",
        ShortName: "l",
        Usage:     "show all emoji list",
    ...
    },
    {
        Name:      "random",
        ShortName: "r",
        Usage:     "show one emoji at random",
        Action: func(c *cli.Context) {
            rand.Seed(time.Now().UTC().UnixNano())
            random_index := rand.Intn(len(emoji))
    ...
    },
    {
        ...
        Action: func(c *cli.Context) {
            ...
            if len(c.Args()) > 0 {
                ...
                fmt.Println("argument error! you have to specify search word.")
                return
            }
